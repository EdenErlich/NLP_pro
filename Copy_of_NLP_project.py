...
get_ipython().system('pip install sentence-transformers faiss-cpu transformers accelerate')
...
get_ipython().system('pip install transformers accelerate bitsandbytes')
